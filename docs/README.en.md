...
4. [Model configuration and protocols](./en/model-providers.md): configure LLM/media Providers, use the Universal Model Adapter, author protocols, validate, and troubleshoot.
