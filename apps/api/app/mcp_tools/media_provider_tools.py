...
_MEDIA_API_FORMATS = {"openai", "raw", "raw_post", "volcengine_ark", "xai_video", "grok_1_5", "suno_compatible", "openai_tts"}
...
async def media_add_provider(
    ...
    api_format: 'openai' (default image format), 'raw'/'raw_post', 'volcengine_ark', 'xai_video', 'grok_1_5', 'suno_compatible', or 'openai_tts'
