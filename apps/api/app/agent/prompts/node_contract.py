...
- Active/user skill controls method; image/video default uses `skill.video_production`.
- Put content in title/prompt/fields; upstream inputs in `fields.references`.
- Batch small/low-risk create/update sets; split many nodes, rich prompts, or uncertain edits.
